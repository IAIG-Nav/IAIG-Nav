"""Evaluate an AIG-Nav ablation variant."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Evaluate AIG-Nav ablation variant")
    ...
    model_name = args.model_name.strip() or f"AIGNav_{args.variant}"
