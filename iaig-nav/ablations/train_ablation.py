"""Train an AIG-Nav ablation variant."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train AIG-Nav ablation")
    ...
    model = AIGNav(
        ...
        model_name=f"AIGNav_{args.variant}",
        # === IAIG parameters ===
    ...
    print("=" * 60)
    _method_tag = "IAIG-Nav" if args.use_iterative_eq else "AIG-Nav"
